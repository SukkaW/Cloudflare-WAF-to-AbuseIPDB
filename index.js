...
function reportToAbuseIPDB(iplist) {
    function report(ip) {
        ...
        form.append('ip', ip);
        form.append('comment', encodeURI('The IP has triggered Cloudflare WAF. Report generated by Cloudflare-WAF-to-AbuseIPDB (https://github.com/SukkaW/Cloudflare-WAF-to-AbuseIPDB)'));
